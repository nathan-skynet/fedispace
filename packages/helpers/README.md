...
- [Widgets Helpers](#widgets-helpers)
  - [SlidingBottomSheet](#slidingbottomsheet-widget) **FAVORITE**
  - [SlidingBottomSheetContainer](#slidingbottomsheetcontainer-widget)
...
- ### **SlidingBottomSheetContainer Widget:**
  Useful for entering content to the [SlidingBottomSheetPage](#slidingbottomsheetpage-widget) [builder]
