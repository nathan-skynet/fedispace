// Initial Import
import 'package:fedispace/widgets/story_widget.dart';
...
class _Profile extends State<Profile> {
  final apiService = ApiService(); final title = 'Fedi Space';
  ...
  Future<Object> fetchAccount() async {
    ...
    if(arguments["id"] != null){
      AccountUsers currentAccount = (await widget.apiService.getUserAccount(arguments["id"].toString()));
  ...
  Widget build(BuildContext context) {
    ...
    if(snapshot.hasData) {
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  children: [
                                    Text(
                                      getFormattedNumber(UserAccount?.statuses_count),
                                      style:
                                ...
                                Column(
                                  children: [
                                    Text(
                                      getFormattedNumber(UserAccount?.followers_count),
                                      style:
                                      const TextStyle(fontWeight: FontWeight.bold),
                                    ),
                                ...
                                Column(
                                  children: [
                                    Text(
                                      getFormattedNumber(UserAccount?.following_count),
                                      style:
                                      const TextStyle(fontWeight: FontWeight.bold),
                                    ),
     ...
     if (snapshot.hasError){
       return const Center(child: Text("Error dans la fonction profile"));
    }
    return const Center(
